...
namespace MvcOnlineTicariOtamasyon.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var deger13 = c.Uruns.Where(k => k.UrunID == (c.SatisHarekets.GroupBy(x => x.Urunid).OrderByDescending(z => z.Count()).Select(y => y.Key).FirstOrDefault())).Select(u => u.UrunAd).FirstOrDefault();
            ViewBag.d13 = deger13;
